...
หรือหากมีข้อผิดพลาด เช่น ลืม Check-in จนกระทั่งระบบส่งและเปิดเผยข้อมูลไปแล้ว เจ้าของเอกสารก็ยังได้รับข้อความเตือนใน LINE และ Email อีกครั้ง เพื่อทำการยับยั้งเอกสาร Google Docs และ Google Drive ที่เผยแพร่ไปแล้วได้ทันเวลาก่อนที่ผู้รับจะเปิดอ่านได้